...
console.log('Starting dVideo APP')

FlowRouter.wait();
Meteor.startup(function(){
  console.log('dVideo APP Started')
  ...
  var sc2 = sc2sdk.Initialize({
    app: 'dvideo.app',
    callbackURL: 'https://dvideo.io/#!/sc2login',
  ...
  // steem.api.getAccounts(['dvideo'], function(err, result) {
  ...
  //   const repoPath = 'dvideo-'+String(Math.random())
  //
  //   const node = new Ipfs({
  //     repo: repoPath,
  //     config: {
