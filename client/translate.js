...
window.loadDefaultLang = function(cb = function(){}){
  var url = 'https://dvideo.io/DVideo_files/lang/en/en-US.json'
  if (window.location.hostname == 'localhost' && window.location.port == '3000')
  url = url.replace('https://dvideo.io', 'http://localhost:3000')
...
window.loadJsonTranslate = function(culture, cb = function(){}){
  ...
  var url = 'https://dvideo.io/DVideo_files/lang/'+Meteor.settings.public.lang[culture].path
  if (window.location.hostname == 'localhost' && window.location.port == '3000')
  url = url.replace('https://dvideo.io', 'http://localhost:3000')
  $.get(url, function(json, result) {
    if (result == 'success') {
